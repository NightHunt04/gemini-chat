    ...
    return (
        <div className="w-full h-full flex text-lg md:text-xl p-5 flex-col bg-transparent justify-center items-center">
            ...
            <div className="relative flex flex-col md:flex-row lg:flex-row items-center gap-2 lg:gap-7 md:gap-3 sm:gap-4 p-2 lg:p-5 lg:mt-[60px] md:p-2 md:mt-[40px] justify-start">
                <div className="w-full h-[506px] mt-10 lg:w-[500px] lg:h-[620px] md:w-[350px] md:h-[520px] overflow-hidden rounded-xl bg-gradient-to-r from-[#d8b4fe] to-[#93c5fd] p-px opacity-85 hover:cursor-pointer shadow-lg hover:shadow-lg hover:shadow-[#93c5fd] transition duration-[0.6s]" onClick={e => navigate('/chat')}>
                ...
                <div className="w-full h-[506px] mt-10 lg:w-[500px] lg:h-[620px] md:w-[350px] md:h-[520px] overflow-hidden rounded-xl bg-gradient-to-b from-[#d8b4fe] to-[#93c5fd] p-px opacity-85 hover:cursor-pointer shadow-lg hover:shadow-lg hover:shadow-[#d8b4fe] transition duration-[0.6s]">
                    <div className='w-full h-full p-6 sm:p-7 rounded-[calc(0.75rem-1px)] bg-slate-950'>
